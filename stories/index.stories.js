...
<taocode-audio-player skiptime="5" showskip="show" showskiptime="show" showadvance="show" advance="loop" playlist="https://assets.mixkit.co/sfx/preview/mixkit-mystwrious-bass-pulse-2298.mp3">
</taocode-audio-player>
<p>This minimal player uses showcontrols="hide".</p>
</div> `;
...
<taocode-audio-player showcontrols="hide" expandplaylist="always" showplaylistbutton="hide" playlist='["https://download.pariyatti.org/free/_moIbLs95/along_the_path_audio/streaming/Lumbini.mp3",
...
<p>A minimal player with exposed playlist.</p>
</div> `;

export const multipleTracks = () => html` 
<div>
<h2>Multiple Tracks Example:</h2>
<taocode-audio-player showskip="show" showadvance="show" playlist='["https://download.pariyatti.org/free/_moIbLs95/along_the_path_audio/streaming/Lumbini.mp3",
"https://download.pariyatti.org/free/_moIbLs95/Dana_The_Practice_of_Giving_single.mp3",
"https://download.pariyatti.org/free/_moIbLs95/along_the_path_audio/streaming/Great_Compassion.mp3"]'>
</taocode-audio-player>
